...
def ComputeSplineC2( DataPts ) :
    ...
    #
    # Fill the matrix of the system M.
    #          C0  :  n+1 rows
    #          C1  :  n-1 rows
    #          C2  :  n-1 rows
...
if __name__ == "__main__":
    ...
    if not os.path.isfile(filename) :
        ...
        for i in range(0,n) :
            ...
            #
            # Put the control points of i-th spline segment into iBezierPts.
            ...
            for j in range(deg + 1):
                iBezierPts[j] = BezierPts[i * deg + j]
        ...
        plt.savefig( DATADIR + dataname + "_" + cstr.lower() + "_" + str(density) + ".png" )
